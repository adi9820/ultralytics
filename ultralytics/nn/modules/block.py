...
class C3(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        """
        Faster Implemnetation of the CSP Bottleneck with 3 convolutions.
...
class A2C2f(nn.Module): # ABC3
    ...
    def __init__(self, c1, c2, n=1, a2=True, area=1, residual=False, g=1, e=0.5, mlp_ratio=2.0, shortcut=True):
        ...
        if a2:
            ...
            self.n = nn.Sequential(*(Bottleneck(c_, c_, shortcut, g=2, k=((3, 3), (1, 1)), e=1.0) for _ in range(n)))
            self.m = nn.Sequential(*(Bottleneck(c_, c_, shortcut, g=2, k=((1, 1), (3, 3)), e=1.0) for _ in range(n)))
